function [eez, hhx, hhy] = CylinderScattering_AngleTest(cylinder_options, simulation_options, ...
    ...
    elseif boundary == "PML"
        for t = 0:dt:Tmax            
            ...
            % Update source
            Ez(Npml+N_x-1, floor(N_y_new/2)) = sin(2*pi*f0*t);       
